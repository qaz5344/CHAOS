				...
				<c:if test="${Nick == null }">
					<div class="card gedf-card">
						<div class="card-header">
							<div class="ml-2">
								<div class="h5 m-0">로그인을 하고 글을 작성해봐요</div>
							</div>
						</div>
					</div>
				</c:if>
				<c:if test="${Nick != null }">
					<div class="card gedf-card" id="HHH">
						<div class="card-header">
						...
						<form action="add" enctype="multipart/form-data" method="post">
							<input type="hidden" name="nick" value="${Nick}"> <input
								type="hidden" name="pname" value="${mDTO.pname}">
							<div class="card-body">
									...
									<div class="tab-pane fade show active" id="posts"
										...
										<div class="form-group">
											...
											<textarea class="form-control" id="message" rows="3"
												name="content" onblur="showbtn()"></textarea>
										</div>
									</div>
										...
										<div class="form-group">
											<div class="custom-file">
												<input type="file" name="file" multiple="multiple"
													class="custom-file-input" id="Fname" value="파일선택">
